...
impl RelevanceScore {
	...
	pub fn new(score: f64, reason: impl Into<String>, matched_terms: Vec<String>) -> Self {
		RelevanceScore { score: score.clamp(0.0, 1.0), reason: reason.into(), matched_terms }
	}
...
pub fn default_batch_score<S: RelevanceScorer>(scorer: &S, items: &[&str], context: &str) -> Vec<RelevanceScore> {
