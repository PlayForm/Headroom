...
impl ReformatOutput {
	pub fn from_lengths(input_len: usize, output: String) -> Self {
		Self { bytes_saved: input_len.saturating_sub(output.len()), output }
	}
}
...
impl OffloadOutput {
	pub fn from_lengths(input_len: usize, output: String, cache_key: String) -> Self {
		Self { bytes_saved: input_len.saturating_sub(output.len()), output, cache_key }
	}
}
...
impl CompressionContext {
	pub fn with_query(query: impl Into<String>) -> Self {
		Self { query: query.into(), token_budget: None }
	}
	pub fn with_budget(token_budget: usize) -> Self {
		Self { query: String::new(), token_budget: Some(token_budget) }
	}
}
