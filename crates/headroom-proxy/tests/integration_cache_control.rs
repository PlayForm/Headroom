...
fn cache_control_marker_at_message_3_yields_frozen_count_4() {
	...
	assert_eq!(resolve_frozen_count(&body, CacheControlAutoFrozen::Enabled, "test-req-1"), 4);
}
...
fn cache_control_in_system_blocks_does_not_bump_frozen_count() {
	...
	assert_eq!(resolve_frozen_count(&body, CacheControlAutoFrozen::Enabled, "test-req-2"), 0);
}
...
fn cache_control_in_tools_does_not_bump_frozen_count() {
	...
	assert_eq!(resolve_frozen_count(&body, CacheControlAutoFrozen::Enabled, "test-req-3"), 0);
}
...
fn cache_control_ttl_1h_before_5m_passes_no_warn() {
	...
	assert_eq!(resolve_frozen_count(&body, CacheControlAutoFrozen::Enabled, "test-req-4"), 2);
}
...
fn cache_control_no_markers_yields_zero() {
	...
	assert_eq!(resolve_frozen_count(&body, CacheControlAutoFrozen::Enabled, "test-req-5"), 0);
}
...
fn cache_control_multiple_markers_in_messages_returns_max_index() {
	...
	assert_eq!(resolve_frozen_count(&body, CacheControlAutoFrozen::Enabled, "test-req-6"), 5);
}
...
fn cache_control_disabled_via_config_returns_zero_even_with_markers() {
	...
	assert_eq!(resolve_frozen_count(&body, CacheControlAutoFrozen::Enabled, "test-req-7b"), 3);
}
