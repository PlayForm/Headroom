...
use super::metric_names::{
	LABEL_PROVIDER, METRIC_PROXY_CACHE_HIT_RATE_PER_SESSION, METRIC_PROXY_CACHE_HIT_RATE_PER_SESSION_HELP,
};
...
pub(super) const CACHE_HIT_RATE_BUCKETS: &[f64] = &[0.0, 0.01, 0.05, 0.1, 0.25, 0.5, 0.75, 0.9, 0.95, 0.99, 1.0];
...
pub fn compute_anthropic_session_hit_rate(state: &crate::sse::anthropic::AnthropicStreamState) -> Option<f64> {
