...
CREATE TABLE
	IF NOT EXISTS proxy_telemetry_v2 (
...
CREATE POLICY "anon_insert" ON proxy_telemetry_v2 FOR INSERT TO anon
WITH
	CHECK (true);

CREATE POLICY "anon_select" ON proxy_telemetry_v2 FOR
SELECT
	TO anon USING (true);
